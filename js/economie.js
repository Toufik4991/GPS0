...
const _SVG_ECLAT = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40"><defs><radialGradient id="frec-g" cx="60%" cy="35%" r="65%"><stop offset="0%" stop-color="#fff"/><stop offset="60%" stop-color="#C8E8FF"/><stop offset="100%" stop-color="#8ab4d4" stop-opacity="0"/></radialGradient><filter id="frec-f"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter><style>@keyframes ec-p{0%,100%{opacity:.85}50%{opacity:1}}@keyframes ec-s{0%,100%{opacity:0;transform:scale(.5)}50%{opacity:1;transform:scale(1)}}.ec-b{animation:ec-p 2s ease-in-out infinite}.ec-s{animation:ec-s 1.8s ease-in-out infinite;transform-origin:center}</style></defs><path class="ec-b" d="M26,8 A12,12 0 1,1 26,32 A8,8 0 1,0 26,8Z" fill="url(#frec-g)" filter="url(#frec-f)"/><circle class="ec-s" cx="10" cy="12" r="1.5" fill="#fff"/><circle class="ec-s" cx="32" cy="8" r="1" fill="#C8E8FF" style="animation-delay:.6s"/><circle class="ec-s" cx="8" cy="28" r="1.2" fill="#fff" style="animation-delay:1.2s"/></svg>`;
const _SVG_FRAGMENT = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="44" height="44"><defs><radialGradient id="frfr-g" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="#6ab4d4"/><stop offset="100%" stop-color="#2a4a6a"/></radialGradient><filter id="frfr-f"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter><style>@keyframes fr-a{0%,100%{opacity:.4}50%{opacity:.85}}.fr-a{animation:fr-a 2.5s ease-in-out infinite}</style></defs><circle class="fr-a" cx="22" cy="22" r="21" fill="none" stroke="#4FC3F7" stroke-width="2"/><path d="M14,8 L28,6 L38,16 L36,30 L26,38 L12,36 L6,24 L10,12 Z" fill="url(#frfr-g)" filter="url(#frfr-f)"/><line x1="16" y1="10" x2="24" y2="28" stroke="#4FC3F7" stroke-width="1" opacity=".7"/><line x1="20" y1="8" x2="34" y2="22" stroke="#4FC3F7" stroke-width=".8" opacity=".5"/><line x1="10" y1="22" x2="26" y2="30" stroke="#69ccff" stroke-width=".8" opacity=".6"/></svg>`;
const _SVG_GROS = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50" height="50"><defs><radialGradient id="frgr-g" cx="40%" cy="30%" r="70%"><stop offset="0%" stop-color="#7a6aa8"/><stop offset="100%" stop-color="#2a1a4a"/></radialGradient><filter id="frgr-f"><feGaussianBlur stdDeviation="4" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter><style>@keyframes gr-p{0%,100%{opacity:.5}50%{opacity:1}}.gr-p{animation:gr-p 2s ease-in-out infinite}</style></defs><circle class="gr-p" cx="25" cy="25" r="23" fill="none" stroke="#9a4aff" stroke-width="3"/><path d="M12,10 L30,6 L44,18 L42,36 L28,46 L10,40 L4,26 L8,14 Z" fill="url(#frgr-g)" filter="url(#frgr-f)"/><polygon points="18,14 22,6 26,14" fill="#a06aff" opacity=".9"/><polygon points="30,20 36,14 38,24" fill="#7a4ade" opacity=".9"/><polygon points="14,28 10,36 20,32" fill="#c88aff" opacity=".8"/></svg>`;
const _SVG_COEUR = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 56" width="56" height="56"><defs><radialGradient id="frcl-g" cx="40%" cy="30%" r="70%"><stop offset="0%" stop-color="#fffcaa" stop-opacity=".95"/><stop offset="40%" stop-color="#e8c8f0" stop-opacity=".8"/><stop offset="100%" stop-color="#C8A2C8" stop-opacity=".4"/></radialGradient><filter id="frcl-f"><feGaussianBlur stdDeviation="5" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter><style>@keyframes cl-h{0%,100%{opacity:.4}50%{opacity:.9}}@keyframes cl-r{0%,100%{opacity:.25}50%{opacity:.75}}.cl-h{animation:cl-h 1.8s ease-in-out infinite}.cl-r{animation:cl-r 1.8s ease-in-out infinite}</style></defs><circle class="cl-h" cx="28" cy="28" r="25" fill="none" stroke="#C8A2C8" stroke-width="3"/><circle cx="28" cy="28" r="20" fill="url(#frcl-g)" filter="url(#frcl-f)" opacity=".9"/><circle cx="28" cy="28" r="9" fill="#FFD700" opacity=".95" filter="url(#frcl-f)"/><line class="cl-r" x1="28" y1="2" x2="28" y2="8" stroke="#C8A2C8" stroke-width="2"/><line class="cl-r" x1="28" y1="48" x2="28" y2="54" stroke="#C8A2C8" stroke-width="2" style="animation-delay:.4s"/><line class="cl-r" x1="2" y1="28" x2="8" y2="28" stroke="#C8A2C8" stroke-width="2" style="animation-delay:.8s"/><line class="cl-r" x1="48" y1="28" x2="54" y2="28" stroke="#C8A2C8" stroke-width="2" style="animation-delay:1.2s"/><line class="cl-r" x1="8" y1="8" x2="13" y2="13" stroke="#C8A2C8" stroke-width="1.5" style="animation-delay:.2s"/><line class="cl-r" x1="48" y1="8" x2="43" y2="13" stroke="#C8A2C8" stroke-width="1.5" style="animation-delay:.6s"/><line class="cl-r" x1="8" y1="48" x2="13" y2="43" stroke="#C8A2C8" stroke-width="1.5" style="animation-delay:1s"/><line class="cl-r" x1="48" y1="48" x2="43" y2="43" stroke="#C8A2C8" stroke-width="1.5" style="animation-delay:1.4s"/></svg>`;

window.GPS0_Economie_FRAGMENTS = {
  eclat_lune:    { id: 'eclat_lune',    nom: 'Éclat de Lune',   emoji: '🌙',    svg: _SVG_ECLAT,    desc: '+10% énergie instantanément', rarete: 'Commun',     bonus_energie: 10,  prix: 5,  couleur: '#C8A2C8' },
  fragment_lune: { id: 'fragment_lune', nom: 'Fragment Lunaire', emoji: '💧',    svg: _SVG_FRAGMENT, desc: '+25% énergie instantanément', rarete: 'Peu commun', bonus_energie: 25,  prix: 15, couleur: '#4FC3F7' },
  gros_fragment: { id: 'gros_fragment', nom: 'Gros Fragment',    emoji: '💎',    svg: _SVG_GROS,     desc: '+50% énergie instantanément', rarete: 'Rare',       bonus_energie: 50,  prix: 30, couleur: '#a06aff' },
  coeur_lune:    { id: 'coeur_lune',    nom: 'Cœur de Lune',    emoji: '✨',    svg: _SVG_COEUR,    desc: 'Énergie 100% complète !',    rarete: 'Légendaire', full_recharge: true, prix: 50, couleur: '#FFD700' }
};
